...
def run(args, verbose=False):
    ...
    # print(checkattr(args, 'pdf') or checkattr(args, 'results_dict'))
    ...
    if args.train:
        ...
        # -perform training
        train_fn(
            args, config, model, train_datasets, test_datasets, iters=args.iters, batch_size=args.batch, baseline=baseline,
